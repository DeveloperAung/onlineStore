...
from carts.views import _cart_id, calculate_tax
from .forms import OrderForm, OrderDeliveryAddressForm
import datetime
from .models import Order, Payment, OrderProduct, DeliveryAddress
import json
        ...
        if form.is_valid():
            ...
            if data.order_type and data.order_type == 'deli':
                if from_address.is_valid():
                    ...
                    address_saved = data_address.save()
                else:
            ...
            data.delivery_address = address_saved
            data.save()
